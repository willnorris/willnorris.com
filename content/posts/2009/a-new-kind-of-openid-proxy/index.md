...
of all, _what happens if the proxy's secret salt is compromised?_ This would certainly be a bad thing, but not quite as
...
_What if the user still wants to maintain different personas for different relying parties?_ For example, what if Alice
